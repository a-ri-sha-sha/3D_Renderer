...
Object createCube(double size) {
    ...
    Matrix3d front1;
    front1 << -half, -half, half,
               half, -half, half,
               half,  half, half;
    cube.addTriangle(front1);
    
    Matrix3d front2;
    front2 << -half, -half, half,
               half,  half, half,
              -half,  half, half;
    cube.addTriangle(front2);
    
    Matrix3d back1;
    back1 << -half, -half, -half,
               half, -half, -half,
               half,  half, -half;
    cube.addTriangle(back1);
    
    Matrix3d back2;
    back2 << -half, -half, -half,
               half,  half, -half,
              -half,  half, -half;
    ...
    Matrix3d bottom1;
    bottom1 << -half, -half, -half,
                 half, -half, -half,
                 half, -half,  half;
    cube.addTriangle(bottom1);
    
    Matrix3d bottom2;
    bottom2 << -half, -half, -half,
                 half, -half,  half,
                -half, -half,  half;
    cube.addTriangle(bottom2);
    
    Matrix3d left1;
    left1 << -half, -half, -half,
              -half, -half,  half,
              -half,  half,  half;
    cube.addTriangle(left1);
    
    Matrix3d left2;
    left2 << -half, -half, -half,
              -half,  half,  half,
              -half,  half, -half;
    cube.addTriangle(left2);
    
    Matrix3d right1;
    right1 << half, -half, -half,
               half, -half,  half,
               half,  half,  half;
    cube.addTriangle(right1);
    
    Matrix3d right2;
    right2 << half, -half, -half,
               half,  half,  half,
               half,  half, -half;
