...
public:
    ...
    static Vector3d getOrigin() { return Vector3d(0, 0, 0); }
    ...
    public:
        ...
        const Quaterniond& getRotation() const { return rotation_; }
        
        void setPosition(const Vector3d& pos) { position_ = pos; }
        void setRotation(const Quaterniond& rot) { rotation_ = rot; }
    ...
    const std::vector<ObjectHolder>& getObjectHolders() const { return object_holders_; }
    std::vector<ObjectHolder>& getObjectHolders() { return object_holders_; }
